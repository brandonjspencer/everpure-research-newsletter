...
def cli() -> None:
    ap = argparse.ArgumentParser(
        description="Build normalized deck metadata from Everpure parsed outputs"
    )
    ap.add_argument(
        "--data-dir",
        default="output",
    ...
    ap.add_argument(
        "--local-artifact-dir",
        default=None,
        help="Optional directory of local deck artifacts named by file_id, such as <file_id>.pdf",
    )
    args = ap.parse_args()
